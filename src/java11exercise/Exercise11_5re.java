...
public class Exercise11_5re {
	public static void main(String[] args) {
		ArrayList list = new ArrayList();
		list.add(new Student123 ("홍길동",1,1,100,100,100));
		list.add(new Student123 ("남궁성",1,2,90,70,80));
		list.add(new Student123("김자바",1,3,80,80,90));
		list.add(new Student123 ("이자바",1,4,70,90,70));
		list.add(new Student123 ("안자바",1,5,60,100,80));
